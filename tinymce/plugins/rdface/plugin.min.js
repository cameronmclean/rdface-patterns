 ...
 // get selected schemas
	$.getJSON(b+'/schema_creator/selection.json', function(data) {
		...
		a.on("contextmenu",function(event){
			...
			//Cam Hijacks the code!!!!
			//###############################
			//# Grab selection from editor and submit to NCBO annotator
			//###############################
			
			var term_to_lookup=""; 
			
			term_to_lookup = a.selection.getContent();

			alert("Hey you! Gonna search for "+term_to_lookup);

			var results = {};
			results = classLookup(term_to_lookup);
			//todo - write classLookup function
